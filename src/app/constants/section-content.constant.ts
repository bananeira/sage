...
export const sectionContentModels: SectionContentModel[] = [
    {
        ...
        text: "Hello! I'm Jamil Osoria Peralta. I'm a 17-year-old student. Currently my interests " +
            ...
            "At the moment I'm in my final exam phase. Afterwards, my plan is to study software systems development. " +
    ...
    },
    {
        ...
        text: "The following is a list of the tools and resources that I generally use for learning.the following is a " +
            "list of the tools and resources I generally use to learn and share my results.",
